...
{
    this.helperDistanceExploration = new THREE.Mesh(new THREE.IcosahedronGeometry(1, 1), Engine.Materials.wireframe);
...
//        Engine.scene.add(this.helperHitTest);
    ...
    {
        this.helperHitTest.position.set(testPoint.x, testPoint.y, testPoint.z);
    };
};
